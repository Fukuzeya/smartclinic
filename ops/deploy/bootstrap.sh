...
2. Point DNS A/AAAA records for your domain at this server's public IP.

3. Log this server into GHCR so it can pull private images
...
5. From now on, pushing to main will build images on GitHub Actions,
